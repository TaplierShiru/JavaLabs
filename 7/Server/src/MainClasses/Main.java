...
import VehiclesThreadTools.ServerSenderThread.ServerSenderVehicleRunnable;
...
public class Main {
    ...
    private static void main_lab7(String[] args) throws ClassNotFoundException, DuplicateModelNameException,
        ...
        try {
            ...
            System.out.println("Server is launch");
            ...
            */
            ...
            Runnable r = new ServerSenderVehicleRunnable(serverSocket);
